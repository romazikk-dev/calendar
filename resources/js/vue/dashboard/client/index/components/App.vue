        ...
        <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
            <thead>
                <tr>
                    ...
                    <th data-toggle="tooltip" data-placement="auto" title="Status of client (suspended/active)">
                            ...
                            render: function ( data, type, row, meta ) {
                                ...
                                if(row.suspension != null &&
                                    ...
                                    let reinstateDropQuestion = isSuspentionInFuture ?
                                        `
                                            Do you want undo future suspension for this client?
                                        ` :
                                        `
                                            Do you want reinstate a client?
                                        `;
