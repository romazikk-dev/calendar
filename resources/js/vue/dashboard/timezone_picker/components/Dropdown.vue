<template>
    <div>
        ...
        <div class="dropdown" ref="dropdown">
            ...
            <div @click.prevent.stop class="dropdown-menu" aria-labelledby="dropdownMenuLink">
...
<script>
    import DropdownItemsSearch from "./DropdownItemsSearch.vue";
    export default {
        mounted() {
