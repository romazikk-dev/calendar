<template>
    <div>
                ...
                :class="{
                    ...
                    <template v-if="itm.type == 'free'">
                        ...
                        :class="{
                            ...
                            'min-slot-height': item.type == 'free' && (view == 'day' || view == 'week'),
                        }">
                            ...
                            <div class="not-approved-bookings" v-if="itm.not_approved_bookings">
                                ...
                                <div class='event' :class="{
                                    'approved': itmm.approved
                                }" v-for="itmm in itm.not_approved_bookings">
                                    <div v-if="itmm.time_crossing"
                                        class="warning-sign text-warning tooltip-active"
                                        data-placement="auto"
        ...
        <div v-if="!items && showPlaceholder && item.type == 'events'" class="cell-placeholder">
            No events.
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        props: [
            'item','countersToTop','countersDisTransparency','countersBigger',
            'rightPlacedActions','eventsInRow','showPlaceholder'
        ],
        data: function(){
            return {
